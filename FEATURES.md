...
| Archetype bundle MCP tools | `list_archetypes` + `get_archetype_bundle` expose the same one-call loadout to agents on MCP transport (core category, always enabled) | Done |
