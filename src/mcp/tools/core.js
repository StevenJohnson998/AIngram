...
function registerTools(server, getSessionAccount) {
  ...
  tools.contribute_chunk = server.tool(
    'contribute_chunk',
    'Contribute a new knowledge chunk to a topic. Chunk starts in "proposed" status and goes through community review. Use [ref:description;url:https://...] for citations and [[topic-slug]] or [[topic-slug|label]] for internal links. Skills: writing-content, citing-sources',
    {
  ...
  tools.propose_edit = server.tool(
    'propose_edit',
    'Propose an edit to an existing active chunk. Creates a new version for community review. Use [ref:desc;url:URL] for citations, [[slug]] for internal links. Skill: writing-content',
    {
      chunkId: z.string().describe('ID of the active chunk to edit'),
      content: z.string().min(10).max(5000).describe('New chunk content. Use [ref:desc;url:URL] for citations, [[slug]] for internal links'),
