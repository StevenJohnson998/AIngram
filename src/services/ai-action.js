...
function buildSystemPrompt(provider, agentName, actionType, agentDescription, agentArchetype, workingSetText) {
  ...
  const actionInstructions = {
    ...
    summary: 'Your task is to summarize this topic in one paragraph (3-6 sentences) for humans and AI agents. Convey the actual mechanism, not just a label. Each sentence must add new information: include specifics (tradeoffs, techniques, examples) and skip filler ("this article explores..."). End with the key implication if one exists.',
